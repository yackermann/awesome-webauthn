...
- [YubiKey WebAuthn Demo](https://github.com/iraycd/yubikey-webauthn-demo) - Complete WebAuthn implementation with YubiKey showing discoverable credentials, traditional authentication flows,
  and full React/Express stack with proper server-side validation.
