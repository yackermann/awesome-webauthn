...
## Articles
 - [Yuriy Ackermann: WebAuthn/FIDO2: Verifying responses](https://medium.com/@herrjemand/verifying-fido2-responses-4691288c8770)
 - [Auth0: Introduction to Web Authentication](https://auth0.com/blog/introduction-to-web-authentication/)
 - [@watahani's Blog in Japanese](https://blog.haniyama.com/) - [Description in Japanese]
