...
- [Wembat WebAuthn Demo](https://demo.wembat.dev) - A vue example of the wembat client library showcasing the encrypttion and authentication functionalities with [wembat.dev](https://wembat.dev)
